...
#define ERROR_NACK_COMMAND -2
#define ERROR_UNAVAILABLE_COMMAND -3

#define PROTOCOL 0x01
#define INCOMPLETE_FRAME_STM32 0x01
#define INVALID_CHECKSUM 0x02

#define APP_LAYER 0x02
#define NACK_COMMAND 0x01
#define UNAVAILABLE_COMMAND 0x02
